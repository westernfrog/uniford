    ...
    <>
      <section className="bg-white p-6 rounded-xl shadow-sm h-[40%]">
        ...
        <form className="space-y-4 mt-4">
          <div className="flex lg:rounded-full rounded-full shadow-sm ring-1 ring-inset ring-gray-800 focus-within:ring-2 focus-within:ring-inset focus-within:ring-[#B9E390]">
            <input
              type="text"
              name="name"
              id="name"
          ...
          <div className="flex rounded-2xl shadow-sm ring-1 ring-inset ring-gray-800 focus-within:ring-2 focus-within:ring-inset focus-within:ring-[#B9E390]">
            <textarea
              type="text"
              name="name"
              id="name"
